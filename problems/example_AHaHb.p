...
%fof(ratio_colinear_13, axiom, (! [A, B, C] : (ratio13(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
%fof(ratio_colinear_31, axiom, (! [A, B, C] : (ratio31(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
%fof(ratio_colinear_12, axiom, (! [A, B, C] : (ratio12(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
%fof(ratio_colinear_21, axiom, (! [A, B, C] : (ratio21(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
%fof(ratio_colinear_23, axiom, (! [A, B, C] : (ratio23(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
%fof(ratio_colinear_32, axiom, (! [A, B, C] : (ratio32(A, B, B, C) => ? [L] : (inc(A, L) & inc(B, L) & inc(C, L))))).
